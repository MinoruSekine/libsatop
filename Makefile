...
OBJ_DIR := $(OUT_DIR)/obj
TEST_EXEC := $(OUT_DIR)/$(MODULE_NAME)_test
TEST_SRC_DIR := test
...
COVERAGE_HTML_FILE := $(COVERAGE_OUT_DIR)/$(MODULE_NAME)-coverage.html
...
.FORCE:
.PHONY: all clean build-test run-test check cpplint cppcheck doc doxygen site latex
